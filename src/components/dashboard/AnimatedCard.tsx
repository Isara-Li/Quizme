...
export default function GithubCardSkew({ className,title,percentage }: { className?: string ,title: string,percentage: number}) {
  ...
  return (
    ...
    >
      <h1 className="font-mono text-6xl tracking-tight">{percentage}%</h1>

      <p className="text-xl font-medium text-zinc-400">{title}</p>

      <span className="mt-4 text-sm text-zinc-400">2023 Survey</span>
    </div>
  );
}
